...
Only **saved Zotero notes** are searched. Unsaved edits, external Markdown/Obsidian files, plain-text copies, unlinked quotations, and page-only links cannot be traced. Some annotation templates retain a citation but omit an annotation identifier; these require an explicit annotation link to be traceable.
